			...
			<div class="row">
				<div class="col-lg-12 alinhamento-sobre">
					<img src="resources/image/sobre.png" width="180" height="130"
						class="img-responsive center-block alinhamento-img-sobre" alt="">
					<div class=""></div>
				</div>
			</div>
		</div>
			...
			<div class="row">
				<div class="col-lg-12">
					...
					<img src="resources/image/galeria.png" width="180" height="130"
						class="img-responsive center-block img-galeria" alt="">
					<div class="">
						<div class="container">
							<div class="row">
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12 conteudo-edit" sytle="background-image:url('resources/image/fundo-barb.jpg');">
					<img src="resources/image/servicos.png" width="150" height="100"
						class="img-responsive center-block img-servicos" alt="">
					<!--<h1>Servicos</h1>-->
					<div class="row">
						<div class="col-md-4">
							<img src="resources/image/maquina2.png"
								class="img-reponsive img-circle" width="160" height="160" alt="">
							<p class="text-center">
						...
						<div class="col-md-4">
							<img src="resources/image/tesoura2.png"
								class="img-reponsive img-circle person" width="160" height="160"
								alt="">
							<p class="text-center">
						...
						<div class="col-md-4">
							<img src="resources/image/pe2.png"
								...
								alt="">
							<p class="text-center">
								<strong><h4>Pé (Apenas acabamento)</h4></strong>
							</p>
							<p>R$ 10,00</p>
						</div>
					</div>
					<div class="row">
						<div class="col-md-4">
							<img src="resources/image/navalha2.png"
								class="img-reponsive img-circle person " width="160"
								height="160" alt="">
							<p class="text-center">
				...
				<div class="col-sm-10 col-sm-offset-1" id="logout">
					<div class="page-header page-image-depo">
						<img src="resources/image/depo-user.png" width="180" height="130"
							class="img-responsive center-block img-depo-user" alt="">
					</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<textarea class="form-control" rows="3" id="textArea"
												placeholder="Comentário" cols=""></textarea>
	...
	<section id="contato" class="contato-section" style="">
			...
			<div class="row">
				<div class="col-md-12 conteudo-edit-contato">
					...
					<div class="col-md-6">
						<div class="row">
							<div class="form-edit">
								<form class="form-horizontal form-edit-campos" action="">
									...
									<fieldset>
										...
										<div class="form-group">
											...
											<div class="col-lg-9">
												<textarea class="form-control" rows="3" id="textArea"
													placeholder="Digite suas Dúvidas e Sugestões" cols=""></textarea>
												<span class="help-block">Envienos-nos seu nome e
													e-mail com dúvidas e sugestões, e entraremos em contato o
		...
		<div class="copyright center-block text-align">
			<p>&copy; Os Horários do site seguem a Hora Oficial de Brasília
				(GMT -3) &copy; 2017, Barbearia Leopoldinense TODOS OS DIREITOS
				RESERVADOS.</p>
		</div>
	</section>

	<a id="btn-top" href="#page-top"><span class="glyphicon glyphicon glyphicon-upload"></span></a>
